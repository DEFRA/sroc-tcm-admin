...
class NotifyMail
  ...
  #
  #   {"name":"personalisation","unparsed_value":{"name":"Luke Skywalker","link":"http://localhost:3001/auth/password/edit?reset_password_token=q-WtfanSr4sjsDm_FB8R"},"charset":"UTF-8","field_order_id":100,"field":{"errors":[],"charset":"UTF-8","name":"personalisation","length":null,"element":null,"value":"{:name=\u003e\"Luke Skywalker\", :link=\u003e\"http://localhost:3001/auth/password/edit?reset_password_token=q-WtfanSr4sjsDm_FB8R\"}"}}
  #
