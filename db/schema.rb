...
ActiveRecord::Schema[7.0].define(version: 2021_11_08_161905) do
  ...
  create_table "export_data_files", force: :cascade do |t|
    t.bigint "regime_id"
    t.string "filename", null: false
    t.datetime "last_exported_at", precision: nil
  ...
  create_table "permits", force: :cascade do |t|
    ...
    t.datetime "pre_construction_end", precision: nil
    t.boolean "temporary_cessation", null: false
    t.datetime "temporary_cessation_start", precision: nil
    t.datetime "temporary_cessation_end", precision: nil
  ...
  create_table "regimes", force: :cascade do |t|
    ...
    t.string "title"
    t.datetime "retrospective_cut_off_date", precision: nil, default: "2018-04-01 00:00:00", null: false
  ...
  create_table "system_configs", force: :cascade do |t|
    ...
    t.datetime "import_started_at", precision: nil
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "transaction_details", force: :cascade do |t|
    ...
    t.datetime "generated_file_at", precision: nil
    ...
    t.datetime "original_file_date", precision: nil
    ...
    t.datetime "approved_for_billing_at", precision: nil
